...
BATTERY_MAX = 200
# BATTERY_DECAY_RATE = 1.0 # Battery decay per time step
BATTERY_DECAY_RATE = 0.5 # Battery decay per time step, half of the original value to extend Animat lifespan
